...
namespace Etapa4.Models
{
    ...
    public class Pessoa
    {
        ...
        // Desconstrutor:
        // Método especial capaz de criar variáveis novas desassociadas da
        // classe de referência. Exemplo:
        // Ambas as variáveis serão utilizadas para guardar os valores
        // referidos pelas propriedades em variáveis novas que se
        // encontram fora da classe
        //                                 varivael nome    variavel sobrenome
        public void Deconstruct(out string nomeDeconstruct, out string sobrenomeDeconstruct) {
			nomeDeconstruct = Nome;
			sobrenomeDeconstruct = Sobrenome;
		}
