-- Para criar uma tabela em SQL basta utilizar os comandos
-- CREATE TABLE e inserir o nome da tabela seguida de ()
CREATE TABLE Produtos(
-- Cada declaração dentro dessa estrutura representa uma coluna
-- A declaração é composta de: nome da coluna, tipo, definições extras...
	...
	-- A dieferença é que varchar() irá receber valores em
	-- string de tamanhos variáveis que tenham, no máximo,
	-- o valor passado entre parênteses.
	-- Já o var() terá SEMPRE de receber valores de tamanho
	-- fixo, nesse caso, tamanho 1.
)

-- O tipos existentes em SQL são inúmeros, porém, sempre há os tipos de
-- valores padrão que sempre serão utilizados justamente com o intuito de
-- criar uma semelhança entre as plataformas.
-- Exemplo: datetime2 é mais utilizado que datetime1
--			decimal é mais utilizado que money
			(etc.)

-- Exibindo a tabela criada:
SELECT * FROM Produtos	

-- Adicionando dados à tabela Produtos
